├─ Animations
  └─ enermy1Destroyed.anim
  └─ enermy1Destroyed.anim.meta
  └─ enermy1Hited.anim
  └─ enermy1Hited.anim.meta
  └─ enermy2Destroyed.anim
  └─ enermy2Destroyed.anim.meta
  └─ enermy2Hited.anim
  └─ enermy2Hited.anim.meta
  └─ enermyDestroyed.anim
  └─ enermyDestroyed.anim.meta
  └─ loading.anim
  └─ loading.anim.meta
  └─ player.anim
  └─ player.anim.meta
  └─ playerDestroyed.anim
  └─ playerDestroyed.anim.meta
  └─ playerHited.anim
  └─ playerHited.anim.meta
  └─ reward1.anim
  └─ reward1.anim.meta
└─ Animations.meta
├─ Image
  ...
  └─ enemy0.png.meta
  └─ enemy0_down1.png
  └─ enemy0_down1.png.meta
  └─ enemy0_down2.png
  └─ enemy0_down2.png.meta
  └─ enemy0_down3.png
  └─ enemy0_down3.png.meta
  └─ enemy0_down4.png
  └─ enemy0_down4.png.meta
  └─ enemy1.png
  └─ enemy1.png.meta
  └─ enemy1_down1.png
  └─ enemy1_down1.png.meta
  └─ enemy1_down2.png
  └─ enemy1_down2.png.meta
  └─ enemy1_down3.png
  └─ enemy1_down3.png.meta
  └─ enemy1_down4.png
  └─ enemy1_down4.png.meta
  └─ enemy1_hit.png
  └─ enemy1_hit.png.meta
  └─ enemy2.png
  └─ enemy2.png.meta
  └─ enemy2_down1.png
  └─ enemy2_down1.png.meta
  └─ enemy2_down2.png
  └─ enemy2_down2.png.meta
  └─ enemy2_down3.png
  └─ enemy2_down3.png.meta
  └─ enemy2_down4.png
  └─ enemy2_down4.png.meta
  └─ enemy2_down5.png
  └─ enemy2_down5.png.meta
  └─ enemy2_down6.png
  └─ enemy2_down6.png.meta
  └─ enemy2_hit.png
  └─ enemy2_hit.png.meta
  └─ enemy2_n2.png
  └─ enemy2_n2.png.meta
  ...
  └─ gameover.png.meta
  └─ game_loading1.png
  └─ game_loading1.png.meta
  └─ game_loading2.png
  └─ game_loading2.png.meta
  └─ game_loading3.png
  └─ game_loading3.png.meta
  └─ game_loading4.png
  └─ game_loading4.png.meta
  └─ game_pause_nor.png
  └─ game_pause_nor.png.meta
  └─ game_pause_pressed.png
  └─ game_pause_pressed.png.meta
  └─ game_resume_nor.png
  └─ game_resume_nor.png.meta
  └─ game_resume_pressed.png
  └─ game_resume_pressed.png.meta
  └─ hero1.png
  └─ hero1.png.meta
  └─ hero2.png
  └─ hero2.png.meta
  └─ hero_blowup_n1.png
  └─ hero_blowup_n1.png.meta
  └─ hero_blowup_n2.png
  └─ hero_blowup_n2.png.meta
  └─ hero_blowup_n3.png
  └─ hero_blowup_n3.png.meta
  └─ hero_blowup_n4.png
  └─ hero_blowup_n4.png.meta
  └─ icon72x72.png
  └─ icon72x72.png.meta
  └─ loading.png
  └─ loading.png.meta
  ...
  └─ progress.png.meta
  └─ prop_type_0.png
  └─ prop_type_0.png.meta
  └─ prop_type_1.png
  └─ prop_type_1.png.meta
  └─ quit_nor.png
  └─ quit_nor.png.meta
  └─ quit_sel.png
  └─ quit_sel.png.meta
  └─ restart_nor.png
  └─ restart_nor.png.meta
  └─ restart_sel.png
  └─ restart_sel.png.meta
  └─ resume_nor.png
  └─ resume_nor.png.meta
  └─ resume_sel.png
  └─ resume_sel.png.meta
...
├─ Sound
  └─ achievement.mp3
  └─ achievement.mp3.meta
  └─ big_spaceship_flying.mp3
  └─ big_spaceship_flying.mp3.meta
  └─ bullet.mp3
  └─ bullet.mp3.meta
  └─ button.mp3
  └─ button.mp3.meta
  └─ enemy0_down.mp3
  └─ enemy0_down.mp3.meta
  └─ enemy1_down.mp3
